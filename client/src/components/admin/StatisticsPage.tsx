    ...
    <div className='app-container'>
      ...
      >
        ...
        >
          ...
          <Bar name='Total items sold' dataKey="items" fill='#3BD4AE' barSize={65} radius={[5, 5, 0, 0]} />
          <Bar name='Total orders' dataKey="orders" fill='#3BD4EE' barSize={65} radius={[5, 5, 0, 0]} />
        </BarChart>
      </ResponsiveContainer>
    </div>
  )
